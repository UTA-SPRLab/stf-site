...
const Navbar = () => {
	...
	return (
		...
		// 	<nav className={`flex p-4 text-base w-screen max-w-full justify-between items-center text-white bg-black bg-opacity-80 backdrop-blur backdrop-saturate-150`}>
		// 		<Link href={"/"}>
		// 			<h1 className="logo font-bold tracking-wide">Social Threat Finder</h1>
		// 		</Link>
		// 		<div
		...
		// 			<div></div>
		// 		</div>
		// 		<div className={`${navActive ? "active right-0" : ""} nav__menu-list text-white bg-black bg-opacity-80 backdrop-blur backdrop-saturate-150`}>
...
// 				<Link href={"/"}>
// 					<h1 className="logo">Social Threat Finder</h1>
// 				</Link>
// 				<div
// 					onClick={() => setNavActive(!navActive)}
// 					className={`flex flex-col cursor-pointer gap-2`}
// 				>
// 					<div className={`no-underline text-inherit w-10 h-1 bg-black rounded-sm`}></div>
// 					<div className={`no-underline text-inherit w-10 h-1 bg-black rounded-sm`}></div>
// 					<div className={`no-underline text-inherit w-10 h-1 bg-black rounded-sm`}></div>
// 				</div>
// 				<div className={`${navActive ? "active" : ""} flex flex-col fixed bg-gray-200 top-16 -right-72 gap-6 w-72 py-6 px-4 transition-all duration-200 min-h-[calc(100%-60px)]`}>
// 					{MENU_LIST.map((menu, idx) => (
// 						<div
// 							onClick={() => {
// 								setActiveIdx(idx);
...
// //         {/* <a className="underline hover:text-success duration-200 transition-colors"></a> */}
// //       </h4>
// //     </section>
// //   )
// // }
